...
const ROUTE_TITLES: Record<string, string> = {
  ...
  '/value-global':    'VALUE Global — US + EU Combinado',
  ...
  '/industry-groups': 'Industry Groups — Fuerza Relativa',
  ...
  '/macro-radar':     'Macro Radar — Régimen de Mercado',
  '/macro-countries': 'Macro Países — Análisis por País',
  '/macro-calendar':  'Macro Calendar — Eventos Económicos',
  '/earnings':        'Earnings Calendar',
  '/dividend-traps':  'Dividend Traps — Rendimientos Peligrosos',
  '/smart-portfolio': 'Smart Portfolio — Optimización',
  '/hedge-funds':     'Hedge Funds — Posiciones 13F',
  '/factor-status':   'Factor Status — Momentum / Value / Quality',
  '/my-portfolio':    'Mi Portfolio Personal',
  '/compare':         'Comparador de Tickers',
  '/cerebro':         'Cerebro IA — Señales Proactivas',
  '/alerts':          'Alertas de Precio',
  '/screener':        'Screener Fundamental',
  '/micro-cap':       'Micro Cap — Oportunidades Small',
  '/shorts':          'Short Interest — Posiciones Cortas',
  '/technical':       'Technical Signals — Señales Técnicas',
  '/catalysts':       'Catalyst Calendar — Catalizadores',
  '/bounce':          'Bounce Trader — Rebotes Intraday',
